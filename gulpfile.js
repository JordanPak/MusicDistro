...
/**
 * JShint, concat, and minify admin JS
 */
gulp.task('site-js-admin', function() {
...
gulp.task('browsersync', function() {
    ...
    gulp.watch('./assets/js/admin/*.js', ['site-js-admin']).on('change', browserSync.reload);
...
gulp.task('watch', function() {
  ...
  // Watch js files
  gulp.watch('./assets/js/admin/*.js', ['site-js-admin']);
...
gulp.task('default', function() {
  gulp.start('styles', 'site-js-admin', 'site-js-foot');
});